...
- Stay honest in the UI and README. Do not claim Raycast store compatibility, Grid layout, extension OAuth, or a shared OAuth client. Form is a list of fields, not Raycast's Form UI.
